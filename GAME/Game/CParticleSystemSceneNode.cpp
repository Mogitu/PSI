...
void CParticleSystemSceneNode::render()
{
	...
	std::cout << "best tests are for the lasts" << endl;
	if (!camera || !driver)
		return;
	...
	for (u32 i=0; i<Particles.size(); ++i)
	{
		...
		std::cout << "Well, this is going to suck but rotation: " << particle.rotation.X << "," << particle.rotation.Y << "," << particle.rotation.Z  << endl;
		#if 0
